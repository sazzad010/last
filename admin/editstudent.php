  ...
  if (isset($_POST['updatestudent'])) {
  	...
  	if (mysqli_query($db_con,$query)) {
		...
		if (!empty($_FILES['photo']['name'])) {
  		...
  		header('Location: student.php?page=all-student&edit=success');
  	}else{
  		header('Location: student.php?page=all-student&edit=error');
  	}
  }
?>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     ...
     <li class="breadcrumb-item" aria-current="page"><a href="student.php?page=all-student">All Student </a></li>
