<?php 
  ...
  if (isset($_POST['userupdate'])) {
  	...
  	if (mysqli_query($db_con,$query)) {
  		...
  		header('Location: student.php?page=user-profile&edit=success');
  	}else{
  		header('Location: student.php?page=user-profile&edit=error');
  	}
  }
?>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     ...
     <li class="breadcrumb-item" aria-current="page"><a href="student.php?page=user-profile">User Profile </a></li>
